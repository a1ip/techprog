...
int main()
{
	...
	char* paragraph = "что-то на русском языке; скорее всего, это что-то даже невозможно будет прочитать; но я всё же постараюсь что-то сделать.";
	...
	cout << "Число слов, совпадающих с первым словом строки: " << entries << endl;
